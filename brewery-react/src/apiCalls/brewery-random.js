  ...
  return (
    <div className="single-container">
      ...
      <div className="randomize-text">
        ...
        <p className="randomize-paragraph">
          Search for a random brewery, here!
        </p>
      </div>
      <button
        ...
        <ul className="brewery-details">
          {breweries.map((brewery) => (
            <li key={brewery.id} className="brewery-details-item">
              <a
                className="brewery-details-link"
              ...
              <div className="brewery-details-group">
                ...
                <a
                  className="brewery-details-contact"
              ...
              <div className="brewery-details-group">
                ...
                {brewery.website_url ? (
                  ...
                  <span className="brewery-details-unavailable">
                    Website Unavailable
                  </span>
                )}
              </div>
              <div className="brewery-details-group">
                ...
                >
                  <a className="fav-button" href="/breweries/favourites">
                    Add to Favourites
                  </a>
                </button>
